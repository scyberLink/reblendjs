...
export interface ReblendPrimitive<P, S> extends Component<P, S> {
...
export type DomNodeChild<P, S> = Component<P, S> | ReblendPrimitive<P, S>;
 ...
 * ```
 */
export type ReblendNode<P = any, S = any> =
  | ReblendElement
  | HTMLs
  | React.ReactNode
...
export interface Component<P, S> extends HTMLElement {
   ...
   */
  ref: Ref<HTMLElement> | ((node: HTMLElement) => any);
  /**
