...
const style: Reblend.CSSProperties = {
  color: 'red',
};

const RefTest = () => {
  const carouselRef = Reblend.useRef<CarouselRef>(null);
...
class ClassComponent extends Reblend.Component {
  render() {
    return <div>abc</div>;
  }
}

const FunctionComponent: Reblend.FC = () => <div>abc</div>;
...
const MegaComponent = () => (
  <>
    ...
    <Alert
      ref={Reblend.createRef<HTMLDivElement>()}
      style={style}
      closeLabel="close"
      dismissible
      onClose={noop}
    ...
    <Form ref={Reblend.createRef<HTMLFormElement>()} as="form" validated>
      <Form.Group
        ref={Reblend.createRef<HTMLDivElement>()}
        as="div"
      ...
      >
        ...
        <Form.Text
          ref={Reblend.createRef<HTMLElement>()}
          as="small"
          muted
          bsPrefix="formtext"
          style={style}
        ...
        <Form.Control
          ...
          ref={Reblend.createRef<HTMLInputElement>()}
          onChange={(e) =>
      ...
      <Form.Group controlId="exampleForm.ControlSelect1">
        ...
        <Form.Select
          ref={Reblend.createRef<HTMLSelectElement>()}
          onChange={(e: Reblend.ChangeEvent<HTMLSelectElement>) => e}
        >
          <option>1</option>
          <option>2</option>
          <option>3</option>
      ...
      <Form.Group controlId="exampleForm.ControlTextarea1">
        ...
        <Form.Control
          as="textarea"
          rows={3}
          ref={Reblend.createRef<HTMLTextAreaElement>()}
          onChange={(e: Reblend.ChangeEvent<HTMLTextAreaElement>) => e}
        />
      </Form.Group>
