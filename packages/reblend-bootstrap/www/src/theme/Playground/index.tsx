import React, { useCallback, useContext, useRef, useState } from 'reblendjs';
...
function Header({ children }: { children: Reblend.ReactNode }) {
...
export default function Playground({
  ...
  previewClassName,
  ...props
}: Props & { previewClassName?: string }): Reblend.JSX.Element {
  const {
