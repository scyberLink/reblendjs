...
export interface CollapseProps
  extends TransitionCallbacks,
    Pick<Reblend.HTMLAttributes<HTMLElement>, 'className' | 'role'> {
  /**
  ...
  /**
   * You must provide a single JSX child element to this component and that element cannot be a \<Reblend.Fragment\>
   */
    ...
    return (
      ...
      >
        {(state: TransitionStatus, innerProps: Record<string, unknown>) =>
          Reblend.cloneElement(children as any, {
            ...innerProps,
            className: clsx(
              className,
