...
import useWillUnmount from 'reblend-hooks/useWillUnmount';
import transitionEnd from 'dom-helpers/transitionEnd';
import * as Reblend from 'reblendjs';
import { useCallback, useMemo, useRef, useState } from 'reblendjs';
...
export interface ModalProps extends BaseModalProps {
   ...
   * @default ModalDialog
   */
  dialogAs?: Reblend.ElementType | undefined;
