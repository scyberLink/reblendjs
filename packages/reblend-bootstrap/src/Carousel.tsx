...
export interface CarouselRef {
  ...
  prev: (e?: Reblend.SyntheticEvent) => void;
  next: (e?: Reblend.SyntheticEvent) => void;
}
...
export interface CarouselProps
   ...
   * Carousel ref.
   */
  ref?: Reblend.Ref<CarouselRef> | undefined;
}
...
const Carousel: DynamicRefForwardingComponent<'div', CarouselProps> =
  (
    ({ defaultActiveIndex = 0, ...uncontrolledProps }) => {
      const {
