...
export type OverlayChildren =
  | Reblend.ReactElement<OverlayInjectedProps>
  | ((injected: OverlayInjectedProps) => Reblend.ReactNode);
...
const Overlay = (
  (
    ...
    const mergedRef = useMergedRefs(outerRef as any);
    ...
    return (
      ...
      >
        {(overlayProps, { arrowProps, popper: popperObj, show }) => {
          ...
          return Reblend.cloneElement(overlay, {
            ...overlayProps,
            placement: updatedPlacement,
            arrowProps,
            popper,
