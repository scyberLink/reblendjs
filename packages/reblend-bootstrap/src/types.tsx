...
export interface BaseDropdownProps {
   ...
   *
   * @type {((eventKey: string | null, e: Reblend.SyntheticEvent<any>) => void) | undefined}
   */
...
export interface BaseNavItemProps extends Reblend.HTMLAttributes<HTMLElement> {
  /**
...
export interface BaseModalProps extends TransitionCallbacks {
   ...
   *
   * @type {((e: Reblend.SyntheticEvent) => void) | undefined}
   */
  onBackdropClick?: ((e: Reblend.SyntheticEvent) => void) | undefined;
