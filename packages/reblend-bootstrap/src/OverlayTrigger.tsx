...
export interface OverlayTriggerProps
  ...
  children:
    ...
    | ((props: OverlayTriggerRenderProps) => Reblend.ReactNode);
  /**
   ...
   *
   * @type {Reblend.ReactElement<OverlayInjectedProps> | ((injected: OverlayInjectedProps) => Reblend.ReactNode)}
   */
...
function handleMouseOverOut(
  handler: (...args: [Reblend.MouseEvent, ...any[]]) => any,
  args: [Reblend.MouseEvent, ...any[]],
...
const OverlayTrigger: Reblend.FC<OverlayTriggerProps> = ({
  trigger = ['hover', 'focus'],
  overlay,
  children,
  popperConfig = {},
  ...
  const { onFocus, onBlur, onClick } =
    typeof children !== 'function'
      ? Reblend.Children.only(children).props
      : ({} as any);
