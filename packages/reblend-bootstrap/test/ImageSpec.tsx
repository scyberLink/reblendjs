...
describe('Image', () => {
  it('should be an image', async () => {
    await render(<Image data-testid="test-image" />);
  ...
  it('should have correct class when fluid prop is set', async () => {
    await render(<Image data-testid="test-image" fluid />);
  ...
  it('should not override class when rounded prop is set', async () => {
    await render(<Image data-testid="test-image" fluid rounded />);
    expect(screen.getByTestId('test-image').classList).toContain('img-fluid');
  ...
  it('should have correct class when rounded prop is set', async () => {
    await render(<Image data-testid="test-image" rounded />);
    expect(screen.getByTestId('test-image').classList).toContain('rounded');
  });

  it('should have correct class when roundedCircle prop is set', async () => {
    await render(<Image data-testid="test-image" roundedCircle />);
  ...
  it('should have correct class when thumbnail prop is set', async () => {
    await render(<Image data-testid="test-image" thumbnail />);
    expect(screen.getByTestId('test-image').classList).toContain(
      'img-thumbnail',
    );
  });
