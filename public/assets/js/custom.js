...
const icon1 = document.querySelector("#header-image");
moon.addEventListener("click", () => {
  ...
  if (theme === "light") {
    //icon && (icon.src = "assets/images/icon/sun.svg");
    icon1 && (icon1.src = "assets/fata img/20230919_130539.png");
    //icon1 && (icon1.style.height = '100px');
    //moon && (moon.style.backgroundColor = "white");
  } else {
    //icon && (icon.src = "assets/images/icon/moon.svg");
    icon1 && (icon1.src = "assets/images/logo/logo.png");
    //icon1 && (icon1.style.height = '70px');
    //moon && (moon.style.backgroundColor = "#00D094");
  }
...
if (scrollToTop) {
  ...
  scrollToTop.addEventListener("click", function (e) {
    e.preventDefault();
    var scrollDuration = -10000; // Set scroll duration in milliseconds
